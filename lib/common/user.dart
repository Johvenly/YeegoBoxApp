...
class User{
  ...
  static const String FIELD_TRUENAME = 'truename';
  ...
  static Future<dynamic> saveUserInfo(Map row) async {
    ...
    prefs.setString(FIELD_TRUENAME, row[FIELD_TRUENAME]);
  ...
  static Future<Map> getUserInfo() async {
    ...
    result[FIELD_TRUENAME] = prefs.getString(FIELD_TRUENAME);
  ...
  //获取单个缓存信息
  static Future<dynamic> getFieldForString(String name) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
